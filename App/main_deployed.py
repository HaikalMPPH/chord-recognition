...
#MODEL = joblib.load("../model/model_rf.xz")
MODEL = tf.keras.models.load_model("/mount/src/Model/model_lstm.keras")
ENCODER = joblib.load("/mount/src/Model/encoder.xz")
SEGMENT_DURATION_SEC = 0.1
SEQ_LEN = 40 # 40 * 0.1 sec (5 sec)
